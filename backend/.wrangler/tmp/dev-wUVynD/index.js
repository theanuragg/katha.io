...
// .wrangler/tmp/bundle-Kheo6m/middleware-loader.entry.ts
init_modules_watch_stub();

// .wrangler/tmp/bundle-Kheo6m/middleware-insertion-facade.js
init_modules_watch_stub();
...
userRouter.post("/signup", async (c) => {
  ...
  try {
    ...
    const json = await sign2({ user: user.id }, c.env.JWT_SECRET);
    return c.json({ json });
  } catch (e) {
    console.log(e);
    c.status(403);
